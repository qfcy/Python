...
ttk.Button(btns,text="清除轨迹",command=clear_screen).grid(row=1,column=2,columnspan=2)
ttk.Button(btns,text="退出",command=exit,width=5).grid(row=1,column=4)
...
scr=Screen()
scr.title("Python 天体引力模拟 - 开普勒第一定律演示")
scr.bgcolor("black")
scr.tracer(0,0)
